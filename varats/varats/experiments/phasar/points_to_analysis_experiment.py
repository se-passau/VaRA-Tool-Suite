...
class PointsToAnalysis(actions.Step):  # type: ignore
    ...
    def analyze(self) -> actions.StepResult:
        ...
        for binary in project.binaries:
            ...
            run_cmd = wrap_unlimit_stack_size(phasarTool[parameters])
...
class PointsToAnalysisExperiment(VersionExperiment):
    ...
    def actions_for_project(self, project: Project) -> tp.List[actions.Step]:
        ...
        analysis_actions.append(PointsToAnalysis(project, "myphasartool"))
        analysis_actions.append(PointsToAnalysis(project, "myphasartool2"))
