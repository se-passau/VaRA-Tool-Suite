...
class SZZFail(bb.Project):  # type: ignore
    """
    Scenario SZZ fail.

    A scenario with a bug that SZZ fails to identify. Scenario adapted from Kim
    et. al. 2006 "Automatic Identification of Bug-Introducing Changes"
    """
